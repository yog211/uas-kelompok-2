...
<div class="container-fluid">
  <div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Uang keluar</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="basic-form text-dark">
            <form action="{{ route('uang_keluar.create') }}" method="post"
              enctype="multipart/form-data">
              @csrf


              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Sumber Uang Keluar</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="sumber_uang_keluar"
                  value="{{ old('sumber_uang_keluar')}}" required>
                </div>
              </div>
